...
imgWhite =
  "<img src=" +
  "https://raw.githubusercontent.com/pukie/othello-game/master/images/white.png" +
  ' class="gameCoin">';
imgBlack =
  "<img src=" +
  "https://raw.githubusercontent.com/pukie/othello-game/master/images/black.png" +
  ' class="gameCoin">';
        ...
        if ($(cordsXY).hasClass("black") || $(cordsXY).hasClass("white")) {
          if ($(cordsXY).hasClass(classTd)) {
            if (coinToChange.length > 0) {
              for (
                var arrayLength = 0;
                arrayLength < coinToChange.length;
                arrayLength++
              ) {
            ...
            ($(cordsXY).hasClass("black") || $(cordsXY).hasClass("white")) &&
            $(cordsXY).hasClass(classChange)
          ) {
